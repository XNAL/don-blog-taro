    ...
    tabBar: {
      ...
      list: [
        ...
        },
        {
          ...
          selectedIconPath: './assets/archive-selected.png'
        },
        {
          pagePath: 'pages/laboratory/index',
          text: '实验室',
          iconPath: './assets/laboratory.png',
          selectedIconPath: './assets/laboratory-selected.png'
        },
        {
